...
class Canvas extends Component {
    ...
    componentDidMount() {
        //   this.setState({     inputImg: "../../../public/img/patagonia.jpg",
    ...
    transferStyle = inputImg => {
        ...
        ml5
            .styleTransfer(this.state.styleModel)
    ...
    handleImgChange = event => {
        ...
        if (this.styleArray.includes(value)) {
            this.setState({[name]: this.styleKey[value].img, styleModel: this.styleKey[value].model})
        } else {
    ...
    handleFileChange = event => {
        ...
        reader.onload = event => {
            this.setState({inputImg: event.target.result})
        };

        reader.readAsDataURL(imageObject);
    };

    // saveImage = (res) => {   let userImgUrl = res.data.secure_url;
    // console.log("userImgUrl: ", userImgUrl);   // add to database }//end of
    // saveImage
                        ...
                        <div className="col-lg-3 col-md-5 text-center column">
                            <div className="img-container text-center mx-auto shadow">
                                {this.state.inputImg
                                    ...
                                    : <p className="img-placeholder">Input Image</p>}
                            </div>
                            <div></div>
                            <form>
                        ...
                        <div className="col-lg-3 col-md-5 text-center column">
                            <div className="img-container text-center mx-auto shadow">
                                {this.state.styleImg
                                    ...
                                    : <p className="img-placeholder">Style Image</p>}
                            </div>
                            <form>
                                <div className="form-group shadow">
                        ...
                        <div className="col-lg-3 col-md-5 text-center column">
                            ...
                            <div className="col-sm-12 text-center">
                                <button
                                    ...
                                    onClick={() => {
                                    this.state.inputImg && this.state.styleImg
                                        ? this.handleSubmit()
